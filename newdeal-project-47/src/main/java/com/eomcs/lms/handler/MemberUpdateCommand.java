...
public class MemberUpdateCommand implements Command {
  ...
  public void execute() {
    ...
    try {
      ...
      String oldCdt= transFormat.format(member.getRegisteredDate());
      ...
      if (cdt.equals("")) {member.setRegisteredDate(Date.valueOf(oldCdt)); }
      else member.setRegisteredDate(Date.valueOf(cdt));
