...
public class App {
  ...
  public static void main(String[] args) {
    ...
    /*    BoardListCommand boardListCommand = new BoardListCommand(keyboard, boards);
    BoardDetailCommand boardDetailCommand = new BoardDetailCommand(keyboard, boards);
    BoardDeleteCommand boardDeleteCommand = new BoardDeleteCommand(keyboard, boards);
    BoardUpdateCommand boardUpdateCommand = new BoardUpdateCommand(keyboard, boards);
    BoardAddCommand boardAddCommand = new BoardAddCommand(keyboard, boards);*/
